...
sub_model = tf.keras.models.load_model('/Users/rijanbhandari/COLLEGE/sixthsem/minorproject/Pahiran/RESTART/model/model_sub')
top_model = tf.keras.models.load_model('/Users/rijanbhandari/COLLEGE/sixthsem/minorproject/Pahiran/RESTART/model/model_top')
bottom_model = tf.keras.models.load_model('/Users/rijanbhandari/COLLEGE/sixthsem/minorproject/Pahiran/RESTART/model/model_bottom')
foot_model = tf.keras.models.load_model('/Users/rijanbhandari/COLLEGE/sixthsem/minorproject/Pahiran/RESTART/model/model_foot')
...
#     path = '/Users/rijanbhandari/COLLEGE/sixthsem/minorproject/Pahiran/Miniversion/smalldataset/images' #/content/images   
#     img = cv2.imread(path)
